...
The web application provides country profiles, country comparison, dimension rankings, source records, observation years, and data-status labels. It is a static Progressive Web App and can be installed on desktop and mobile devices.
